...
const SECTIONS = [
  { id: 'agreement-and-eligibility', title: '1. Agreement and eligibility' },
  { id: 'service-description', title: '2. Service description' },
  { id: 'accounts-and-security', title: '3. Accounts and security' },
  { id: 'acceptable-use', title: '4. Acceptable use' },
  { id: 'open-source-software-and-hosted-service', title: '5. Open-source software and hosted service' },
  { id: 'managed-payments-and-merchant-of-record', title: '6. Managed Payments and merchant of record' },
  { id: 'subscriptions-trials-and-cancellation', title: '7. Subscriptions, trials, and cancellation' },
  { id: 'refunds-and-payment-disputes', title: '8. Refunds and payment disputes' },
  { id: 'angel-lifetime-access', title: '9. Angel lifetime access' },
  { id: 'third-party-content-and-services', title: '10. Third-party content and services' },
  { id: 'intellectual-property-and-feedback', title: '11. Intellectual property and feedback' },
  { id: 'copyright-reports', title: '12. Copyright reports' },
  { id: 'changes-availability-and-termination', title: '13. Changes, availability, and termination' },
  { id: 'disclaimer-of-warranties', title: '14. Disclaimer of warranties' },
  { id: 'limitation-of-liability', title: '15. Limitation of liability' },
  { id: 'indemnification', title: '16. Indemnification' },
  { id: 'dispute-resolution-and-arbitration', title: '17. Dispute resolution and arbitration' },
  { id: 'governing-law-and-general-terms', title: '18. Governing law and general terms' },
  { id: 'changes-and-contact', title: '19. Changes and contact' },
] as const;
  ...
  return (
    ...
    >
      <section className={styles.section}>
        <h2 id="agreement-and-eligibility" className={styles.sectionTitle} tabIndex={-1}>1. Agreement and eligibility</h2>
        ...
        <h2 id="service-description" className={styles.sectionTitle} tabIndex={-1}>2. Service description</h2>
        <p className={styles.text}>
        ...
        <h2 id="accounts-and-security" className={styles.sectionTitle} tabIndex={-1}>3. Accounts and security</h2>
        <p className={styles.text}>
        ...
        <h2 id="acceptable-use" className={styles.sectionTitle} tabIndex={-1}>4. Acceptable use</h2>
        <p className={styles.text}>
        ...
        <h2 id="open-source-software-and-hosted-service" className={styles.sectionTitle} tabIndex={-1}>5. Open-source software and hosted service</h2>
        <p className={styles.text}>
        ...
        <h2 id="managed-payments-and-merchant-of-record" className={styles.sectionTitle} tabIndex={-1}>6. Managed Payments and merchant of record</h2>
        <p className={styles.text}>
        ...
        <h2 id="subscriptions-trials-and-cancellation" className={styles.sectionTitle} tabIndex={-1}>7. Subscriptions, trials, and cancellation</h2>
        <p className={styles.text}>
        ...
        <h2 id="refunds-and-payment-disputes" className={styles.sectionTitle} tabIndex={-1}>8. Refunds and payment disputes</h2>
        <p className={styles.text}>
        ...
        <h2 id="angel-lifetime-access" className={styles.sectionTitle} tabIndex={-1}>9. Angel lifetime access</h2>
        <p className={styles.text}>
        ...
        <h2 id="third-party-content-and-services" className={styles.sectionTitle} tabIndex={-1}>10. Third-party content and services</h2>
        <p className={styles.text}>
        ...
        <h2 id="intellectual-property-and-feedback" className={styles.sectionTitle} tabIndex={-1}>11. Intellectual property and feedback</h2>
        <p className={styles.text}>
        ...
        <h2 id="copyright-reports" className={styles.sectionTitle} tabIndex={-1}>12. Copyright reports</h2>
        <p className={styles.text}>
        ...
        <h2 id="changes-availability-and-termination" className={styles.sectionTitle} tabIndex={-1}>13. Changes, availability, and termination</h2>
        <p className={styles.text}>
        ...
        <h2 id="disclaimer-of-warranties" className={styles.sectionTitle} tabIndex={-1}>14. Disclaimer of warranties</h2>
        <p className={styles.text}>
        ...
        <h2 id="limitation-of-liability" className={styles.sectionTitle} tabIndex={-1}>15. Limitation of liability</h2>
        <p className={styles.text}>
        ...
        <h2 id="indemnification" className={styles.sectionTitle} tabIndex={-1}>16. Indemnification</h2>
        <p className={styles.text}>
        ...
        <h2 id="dispute-resolution-and-arbitration" className={styles.sectionTitle} tabIndex={-1}>17. Dispute resolution and arbitration</h2>
        <p className={styles.text}>
        ...
        <h2 id="governing-law-and-general-terms" className={styles.sectionTitle} tabIndex={-1}>18. Governing law and general terms</h2>
        <p className={styles.text}>
        ...
        <h2 id="changes-and-contact" className={styles.sectionTitle} tabIndex={-1}>19. Changes and contact</h2>
        <p className={styles.text}>
