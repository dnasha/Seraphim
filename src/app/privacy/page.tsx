...
const SECTIONS = [
  { id: 'scope-and-contact', title: '1. Scope and contact' },
  { id: 'information-we-collect', title: '2. Information we collect' },
  { id: 'sources-of-information', title: '3. Sources of information' },
  { id: 'why-we-use-information', title: '4. Why we use information' },
  { id: 'how-we-disclose-information', title: '5. How we disclose information' },
  { id: 'managed-payments-and-link', title: '6. Managed Payments and Link' },
  { id: 'cookies-and-local-storage', title: '7. Cookies and local storage' },
  { id: 'web-analytics-and-optional-metrics', title: '8. Web analytics and optional metrics' },
  ...
  { id: 'your-privacy-rights', title: '13. Your privacy rights' },
  { id: 'adults-only', title: '14. Adults only' },
  { id: 'third-party-links-and-public-sources', title: '15. Third-party links and public sources' },
  { id: 'changes-and-contact', title: '16. Changes and contact' },
] as const;
  ...
  return (
    ...
    >
      <section className={styles.section}>
        <h2 id="scope-and-contact" className={styles.sectionTitle} tabIndex={-1}>1. Scope and contact</h2>
        ...
        <h2 id="information-we-collect" className={styles.sectionTitle} tabIndex={-1}>2. Information we collect</h2>
        <p className={styles.text}>
        ...
        <h2 id="sources-of-information" className={styles.sectionTitle} tabIndex={-1}>3. Sources of information</h2>
        <p className={styles.text}>
        ...
        <h2 id="why-we-use-information" className={styles.sectionTitle} tabIndex={-1}>4. Why we use information</h2>
        <p className={styles.text}>
        ...
        <h2 id="how-we-disclose-information" className={styles.sectionTitle} tabIndex={-1}>5. How we disclose information</h2>
        <p className={styles.text}>
        ...
        <h2 id="managed-payments-and-link" className={styles.sectionTitle} tabIndex={-1}>6. Managed Payments and Link</h2>
        <p className={styles.text}>
        ...
        <h2 id="cookies-and-local-storage" className={styles.sectionTitle} tabIndex={-1}>7. Cookies and local storage</h2>
        <p className={styles.text}>
        ...
        <h2 id="web-analytics-and-optional-metrics" className={styles.sectionTitle} tabIndex={-1}>8. Web analytics and optional metrics</h2>
        <p className={styles.text}>
        ...
        <h2 id="retention" className={styles.sectionTitle} tabIndex={-1}>9. Retention</h2>
        <p className={styles.text}>
        ...
        <h2 id="account-deletion" className={styles.sectionTitle} tabIndex={-1}>10. Account deletion</h2>
        <p className={styles.text}>
        ...
        <h2 id="international-transfers" className={styles.sectionTitle} tabIndex={-1}>11. International transfers</h2>
        <p className={styles.text}>
        ...
        <h2 id="security" className={styles.sectionTitle} tabIndex={-1}>12. Security</h2>
        <p className={styles.text}>
        ...
        <h2 id="your-privacy-rights" className={styles.sectionTitle} tabIndex={-1}>13. Your privacy rights</h2>
        <p className={styles.text}>
        ...
        <h2 id="adults-only" className={styles.sectionTitle} tabIndex={-1}>14. Adults only</h2>
        <p className={styles.text}>
        ...
        <h2 id="third-party-links-and-public-sources" className={styles.sectionTitle} tabIndex={-1}>15. Third-party links and public sources</h2>
        <p className={styles.text}>
        ...
        <h2 id="changes-and-contact" className={styles.sectionTitle} tabIndex={-1}>16. Changes and contact</h2>
        <p className={styles.text}>
